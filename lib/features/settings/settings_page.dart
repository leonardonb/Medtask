...
class _SettingsPageState extends State<SettingsPage> {
  ...
  bool _allowed = false;
  bool _loading = true;
  late final AppSettingsController _app;

  @override
  void initState() {
    super.initState();

    _app = Get.isRegistered<AppSettingsController>()
  ...
  Future<void> _setChoice(AlarmChoice c) async {
    setState(() => _choice = c);
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () async => NotificationService.showNow(),
          ...
          ListTile(
            ...
            onTap: () async => NotificationService.openBatteryOptimizationSettings(),
